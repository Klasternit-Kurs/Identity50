    ...
    public partial class initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Fajls", x => x.ID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Autor_FK = table.Column<int>(type: "integer", nullable: false),
                    Knjiga_FK = table.Column<int>(type: "integer", nullable: false),
                    Izdata = table.Column<DateTime>(type: "timestamp without time zone", nullable: false)
                },
                constraints: table =>
                {
